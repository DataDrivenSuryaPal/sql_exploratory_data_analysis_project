...
SELECT
    gender,
    SUM(customer_key) AS total_customer_by_gen
FROM gold.dim_customers
GROUP BY gender
ORDER BY SUM(customer_key) DESC;
--What is the average cost of each products
SELECT
    category,
...
--What is the distribution of sold items accress country
SELECT
    c.country,
